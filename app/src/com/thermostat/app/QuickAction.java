...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	public void show (View anchor) {
		...
		Log.d("QuickAction", "rootWidth:" +  rootWidth + "\nrootHeight:" +rootHeight +
				"\nscreenWidth:" + screenWidth +"\nscreenHeight:" + screenHeight);

		Log.d("QuickAction", "anchorRect.centerX():" +  anchorRect.centerX());
		int xPos = (anchorRect.centerX() - rootWidth / 2);
		if(xPos < 0) xPos = 0;
		int yPos = anchorRect.top - rootHeight;
        
		Log.d("QuickAction", "xPos:" + xPos + ";\nyPos:" + yPos);
		boolean onTop = true;
		
		anchor.measure(View.MeasureSpec.UNSPECIFIED, View.MeasureSpec.UNSPECIFIED);
		// display on bottom
		if (rootHeight > getRelativeTop(anchor)) {
	...
	private void showArrow(int whichArrow, int requestedX) {
		...
		Log.d("QuickAction", "arrowWidth:" + arrowWidth);
		Log.d("QuickAction", "requestedX:" + requestedX);
		...
		Log.d("QuickAction", "leftMargin:" + param.leftMargin);
